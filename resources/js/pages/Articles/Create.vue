                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <a href="javascript:;" @click="saveOrder()" class="btn btn-success w-md waves-effect waves-light">Create</a>
                      </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-md-4">
                                            <h4 class="font-size-16" style="text-align:center;">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <a href="javascript:;" v-if="form.image" @click="onFileRemove()" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></a>
...
export default {
  ...
  data() {
    ...
    methods: {
        ...
        async fetchData() {
            await axios.get('/api/categories',{params:{paginate:0}}).then(({data}) => {
                this.categories=data.success.categories;
            });
        },
       
        async saveOrder() {
            await  this.form.post('/api/articles').then(({data}) => {
                if(this.form.image){
                    let fd = new FormData();
