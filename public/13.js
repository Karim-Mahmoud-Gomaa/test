        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/api/articles/' + _this.$route.params.article_id + '/edit').then(function (_ref) {
                  var data = _ref.data;
                  _this.categories = data.success.categories;
                  _this.image = '/assets/images/articles/' + data.success.article.image;

                  _this.form.fill(data.success.article);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.form.put('/api/articles/' + _this2.$route.params.article_id).then(function (_ref2) {
                  var data = _ref2.data;

                  if (_this2.form.image) {
                    var fd = new FormData();
                    fd.append("article_id", _this2.$route.params.article_id);
        ...
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-12" }, [
            _c(
              ...
              [
                _c("h4", { staticClass: "mb-0" }, [_vm._v("Edit Article")]),
                _vm._v(" "),
                _c("category-Modal", {
                  ref: "CategoryModal",
