...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    store: function store() {
      ...
      this.form.post("/api/articles").then(function (_ref2) {
        var data = _ref2.data;
    ...
    update: function update() {
      ...
      this.form.put("/api/articles/" + this.form.id).then(function (res) {
        _this3.fetchData();
    ...
    destroy: function destroy(id) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          axios__WEBPACK_IMPORTED_MODULE_1___default.a["delete"]('/api/articles/' + id).then(function (response) {
            if (response.data.message) {
              ...
              _this4.$swal.fire(_this4.$t("general.deleted"), _this4.$t("general.delete_success"), 'success');
              ...
              _c("div", { staticClass: "modal-body row" }, [
                _vm.categories && _vm.categories.length
                  ? _c(
                      ...
                      [
                        _c("label", [_vm._v(_vm._s(_vm.$t("title.category")))]),
                        _vm._v(" "),
                        _c("v-select", {
                          staticClass: "vselect",
                ...
                _c(
                  ...
                  { staticClass: "col-12 mt-3" },
                  [
                    _c("label", [_vm._v(_vm._s(_vm.$t("inf.title")))]),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                ...
                _c(
                  ...
                  { staticClass: "col-12 mt-3" },
                  [
                    _c("label", [_vm._v(_vm._s(_vm.$t("inf.image")))]),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                ...
                _c(
                  ...
                  { staticClass: "col-12 mt-3" },
                  [
                    _c("label", [_vm._v(_vm._s(_vm.$t("inf.content")))]),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
              ...
              _c("div", { staticClass: "modal-footer" }, [
                ...
                _vm.form.id
                  ? _c(
                      ...
                      [_vm._v(_vm._s(_vm.$t("inf.status")))]
                    )
                  : _c(
                      "button",
                      {
            ...
            _c(
              ...
              [
                _c("h4", { staticClass: "mb-0" }, [
                  _vm._v(
                    _vm._s(_vm.$t("general.table", [_vm.$t("title.articles")]))
                  )
                ]),
                _vm._v(" "),
                _c(
                  ...
                  [
                    _c(
                      ...
                      [
                        _vm._v(
                          "\n                                + " +
                            _vm._s(_vm.$t("general.createNew")) +
                            "\n                            "
                        )
                      ]
                    ),
                      ...
                      _c(
                        ...
                        [
                          _c("thead", [
                            _c("tr", [
                              _c("th", [
                                _vm._v(_vm._s(_vm.$t("title.category")))
                              ]),
                              _vm._v(" "),
                              _c("th", [_vm._v(_vm._s(_vm.$t("inf.title")))]),
                              _vm._v(" "),
                              _c("th", [_vm._v(_vm._s(_vm.$t("inf.image")))]),
                              _vm._v(" "),
                              _c("th", [
                                _vm._v(_vm._s(_vm.$t("inf.created_at")))
                              ]),
                              _vm._v(" "),
                              _c("th", [_vm._v(_vm._s(_vm.$t("inf.content")))]),
                              _vm._v(" "),
                              _c("th", [
                                _vm._v(_vm._s(_vm.$t("general.options")))
                              ])
                            ])
                          ]),
                          _vm._v(" "),
                          _c(
                            ...
                            _vm._l(_vm.articles.data, function(article, index) {
                              return _c("tr", [
                                ...
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(article.image))]),
                                _vm._v(" "),
                                _c("td", [
                                  _vm._v(
                                    _vm._s(
